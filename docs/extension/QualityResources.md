...
## 后端工具集
- [开源镜像站-阿里](https://developer.aliyun.com/mirror/?spm=a2c6h.12873639.0.0.4e216a65qSC2oa)
- [GNU-ftp仓库](https://ftp.gnu.org/gnu/)
- [GNU-ftp地址](https://www.gnu.org/prep/ftp.html)
- [七牛云-存储商](https://sso.qiniu.com/)

## 通用工具集
- [数学乐-数学学习平台](https://www.shuxuele.com/index.html)
- [wolframalpha](https://www.wolframalpha.com/)
- [国家数据](https://brownant.top)
- [网站诊断分析-阿里云](https://boce.aliyun.com/home)
- [DNSPod 域名检测工具-腾讯云](https://tool.dnspod.cn)
- [tool-在线工具集](https://tool.lu/)
- [工具集-json.cn-优质博客](https://www.json.cn/json/jsononline.html)
- [代码转换器-transform-github](https://transform.tools)
- [iamwawa-在线工具集](https://www.iamwawa.cn/)
- [开发工具介绍](https://mp.weixin.qq.com/s/fm786-wFvMHXsojTxsThDg)
- [易搜-网盘](https://yiso.fun)
- [推荐网站-微信公众博文](https://mp.weixin.qq.com/s/JsK-Ew_gmkn1e0ysjCsbRQ)
- [网易云游戏](https://cg.163.com/index.html#/pc)
- [游戏商店-Youtube](https://itch.io/games)
- [apple保障支持验证](https://checkcoverage.apple.com/cn/zh/)
- [浏览器麦克风测试](https://www.onlinemictest.com/zh/)
- [ddrk-影音](https:https://www.olevod.com///ddrk.me/)
- [subhd-电影字幕论坛](https://subhd.tv/)
- [表情包-可爱](https://lee-7723.github.io/Silvervale-Emoji/)
- [表情包-可爱](https://lee-7723.github.io/Veibae-Emoji/)
- [photopea-在线PS](https://www.photopea.com/)
- [美图秀秀-在线图片编辑](https://pc.meitu.com/)
- [tinify-图片压缩](https://tinify.cn/)
- [在线常见加解密工具-博客](http://tool.chacuo.net/cryptrsapubkey)
- [RSA在线加密/在线解密-博客](https://the-x.cn/cryptography/Rsa.aspx)
...
> JetBrain开发工具中最为强大的一款开发工具。主打Java开发，调试性能强劲，默认支持前端常用库。可以下载插件扩展功能，付费优质。(唯二的不算缺点的缺点是内存消耗惊人和启动不够更快)
- [VSCode](https://code.visualstudio.com/)
> 开源编辑器，微软出品优质惊人。可以通过增加各类插件来支持开发语言。优点是支持语言广泛(本质上是插件支持语言的扩展功能)，极其轻量级。缺点插件的支持有限，是无法应付大型工程的重构和调试需求的。IDEA可以作为性能要求的互补。
- [Wireshark](https://www.wireshark.org/)
> 开源网络协议分析工具，优质功能强大
- [Termius](https://www.termius.com/)
> SSH客户端管理软件，优点是好看，免费版功能就可以满足基本需求。
- [DBeaver](https://dbeaver.io/)
> 开源数据库管理软件
- [Sourcetree](https://www.sourcetreeapp.com/)
> Git可视化管理工具，使用GUI工具可以方便分析大型工程的分支信息和提交细节。
- [Postman](https://www.postman.com/)
> API测试平台，优质付费，免费版本够用。离线情况下功能会受限。
- [Google Chrome](https://www.google.com/intl/zh-CN/chrome/)
> 浏览器，与其并列好用的有[firefox](https://www.firefox.com.cn/)。(考虑到账号数据同步功能，我个人愿称为Chrome最好用)
